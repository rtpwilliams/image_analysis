...
for(sheet in sheets) {
 toappend <- read_excel("./example_input/JM259_Reps123_elt-2_Promoter_ImageJ_Analysis.xlsx", sheet = sheet)
...
for(sheet in sheets) {
 toappend <- read_excel("./example_input/JM149_Reps123_elt-2_Promoter_ImageJ_Analysis.xlsx", sheet = sheet)
 toappend <- toappend %>% mutate(experiment = sheet)
 toappend$worm <- as.character(toappend$worm)
